...
#
# Usage:
#   bash sim_eval/libero/run_eval_libero_full.sh <overlap_steps> [seeds...]
#
# Required positional:
#   overlap_steps  AsyncStreamingActionManager.overlap_steps. 0 = sync (each
...
#   POLICY_PATH    Default: checkpoints/pi05_flashvla
...
#
# Examples:
#   bash sim_eval/libero/run_eval_libero_full.sh 2                             # 5 seeds, GPU 1
#   GPUS="0 1 2 3" bash sim_eval/libero/run_eval_libero_full.sh 2              # 5 seeds, 4-way parallel
#   bash sim_eval/libero/run_eval_libero_full.sh 0 1000                        # 1 seed
#   N_EPISODES=10 bash sim_eval/libero/run_eval_libero_full.sh 2 1000 2000     # smoke
#   POLICY_PATH=./some_other_ckpt bash sim_eval/libero/run_eval_libero_full.sh 1

set -u

# ---- args ----
if [ "$#" -lt 1 ]; then
  echo "Usage: $0 <overlap_steps> [seeds...]" >&2
  echo "See header for full options." >&2
  exit 2
fi
OVERLAP_STEPS=$1
shift 1
...
# ---- defaults ----
: "${POLICY_PATH:=checkpoints/pi05_flashvla}"
